...
const products = [
  {
    ...
    images: [{ url: 'https://placehold.co/600x600?text=Shoulder+Bag', publicId: 'seed/shoulder-bag-1', alt: 'Classic Shoulder Bag' }],
    sizes: ['Medium', 'Large'],
  ...
  },
  {
    ...
    images: [{ url: 'https://placehold.co/600x600?text=Tote+Bag', publicId: 'seed/tote-bag-1', alt: 'Executive Tote Bag' }],
    sizes: ['Large'],
  ...
  },
  {
    ...
    tags: ['tech', 'office'],
    images: [{ url: 'https://placehold.co/600x600?text=Laptop+Bag', publicId: 'seed/laptop-bag-1', alt: 'Pro Laptop Sleeve Bag' }],
    sizes: ['Medium', 'Large'],
  ...
  },
  {
    ...
    tags: ['casual', 'travel'],
    images: [{ url: 'https://placehold.co/600x600?text=Crossbody+Sling', publicId: 'seed/crossbody-1', alt: 'Mini Crossbody Sling' }],
    sizes: ['Small'],
  ...
  },
  {
    ...
    category: 'handbags',
    tags: ['premium', 'formal'],
    images: [{ url: 'https://placehold.co/600x600?text=Handbag', publicId: 'seed/handbag-1', alt: 'Structured Handbag' }],
    sizes: ['Medium'],
  ...
  },
  {
    ...
    images: [{ url: 'https://placehold.co/600x600?text=Shoulder+Tote', publicId: 'seed/shoulder-tote-1', alt: 'Everyday Shoulder Tote' }],
    sizes: ['Medium', 'Large'],
  ...
  },
  {
    ...
    images: [{ url: 'https://placehold.co/600x600?text=Laptop+Backpack', publicId: 'seed/laptop-backpack-1', alt: 'Convertible Laptop Backpack' }],
    sizes: ['Large'],
